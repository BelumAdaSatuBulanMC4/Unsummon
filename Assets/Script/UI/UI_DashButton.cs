...
public class UI_DashButton : MonoBehaviour
{
    ...
    [SerializeField] private Color enabledColor = new Color(1f, 1f, 1f, 1f);    // Fully visible color
    [SerializeField] private Color disabledColor = new Color(1f, 1f, 1f, 0.5f); // Semi-transparent color
